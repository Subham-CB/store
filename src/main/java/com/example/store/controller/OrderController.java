...
public class OrderController {
    ...
    public ResponseEntity<List<OrderDTO>> getAllOrders(
        ...
        Pageable pageable = pageableBuilder.buildPageable(page,limit,sortBy,sortDir, globalSearchProp.getLimit(),
                globalSearchProp.getSortField(), globalSearchProp.getDirection());
